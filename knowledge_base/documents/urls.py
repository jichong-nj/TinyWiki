...
from .views import (
    ...
    DocumentPublishView,
    DocumentBulkPublishView,
    DocumentQueueAnalyzeView,
    DocumentStatsView,
    DocumentQueueListView,
    MoveDocumentView,
    MoveFolderView,
    DocumentTreeView,
    FullTreeView,
...
urlpatterns = [
    ...
    path('knowledge-bases/<int:knowledge_base_id>/full-tree/', FullTreeView.as_view(), name='knowledge-base-full-tree'),
    ...
    path('documents/bulk-publish/', DocumentBulkPublishView.as_view(), name='document-bulk-publish'),
    ...
    path('documents/queue/', DocumentQueueListView.as_view(), name='document-queue-list'),
    path('documents/<int:pk>/move/', MoveDocumentView.as_view(), name='document-move'),
    path('folders/<int:pk>/move/', MoveFolderView.as_view(), name='folder-move'),
